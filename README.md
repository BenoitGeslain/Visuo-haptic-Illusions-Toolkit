...
+ **C# classes** and their documentation in the [autogenerated docs](https://bjrtx.github.io/Visuo-haptic-Illusions-Toolkit/),
+ the **source code** on [GitHub](https://github.com/BenoitGeslain/Visuo-haptic-Illusions-Toolkit/).

## Getting Started

To get started, you can check the , which contains tutorials and details about the different modules in this toolkit. There is also a [doxygen documentation](https://bjrtx.github.io/Visuo-haptic-Illusions-Toolkit/).
